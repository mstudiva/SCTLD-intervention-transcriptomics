...
#read in counts
counts = read.table("allcounts_transmission_ofav_sym.txt")
...
pdf(file="heatmap_transmission_ofav_sym.pdf", width=15, height=15)
pheatmap(cor(vsd))
dev.off()
...
pdf(file="PCoA_transmission_ofav_sym.pdf", width=12, height=6)
par(mfrow=c(1,2))
...
# 	cat.pos = 3
# 	)
# pdf(file="Venn_transmission_ofav_sym.pdf", height=6, width=6)
...
pdf(file="Venn_transmission_ofav_sym_pairwise.pdf", height=8, width=8)
